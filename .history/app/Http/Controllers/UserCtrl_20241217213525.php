...
class UserCtrl extends Controller
{
  ...
  public function register(Request $request)
  {
      ...
      return redirect('login')->with('success', 'Un e-mail de validation a été envoyé. Veuillez vérifier votre boîte de réception.');
    ...
    public function validateEmail($id)
{
    ...
    return redirect('login')->with('success', 'Votre adresse e-mail a été validée avec succès.');
}
